export default function PercGithubLandingPage() { const featureCards = [ { title: "Expression First", text: "P.E.R.C. opens with reflection, validates emotion without stigma, and helps users move toward calm, balanced communication.", }, { title: "Private Member Access", text: "This experience is intended for paying members only, creating a more focused, protected space for personal reflection.", }, { title: "SoulWynd Codex Aligned", text: "Built on Soul, Signal, and Soil — empathy, integrity, and sustainable pace guide every interaction.", }, ];

const sideMenu = [ "New Reflection", "Today felt heavy", "Help me say this calmly", "What am I carrying?", "How do I slow down?", ];
